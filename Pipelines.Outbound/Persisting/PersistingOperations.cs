...
{
  internal static ValueTask<(TData, PersistingSignal, Exception?)> ExecutePersistingOperationAsync<TServices, TData, TKey, TPayload, TSession>(PersistingActions action, TServices services, TData data, CancellationToken ct = default)

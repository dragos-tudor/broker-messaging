...
public partial class DeadLetterEnvelopeTests
{
  ...
  public void produce_dead_letter_envelope__enqueue_result_varies__returns_matching_state(bool enqueued, Enum expectedState)
  {
    ...
    var (data, state, exception) = DeadLetterEnvelopeFuncs.ProduceDeadLetterEnvelope<IProducingServices<string, byte[], object, string, string>, DeadLetterEnvelopeData, string, byte[], object, string, string>(services, inputData);
